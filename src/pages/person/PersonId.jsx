    ...
    <PagelayoutId
      ...
      <div className="mt-4">
        ...
        <div
            ...
            {showPicModal && <Imagebox setShowPicModal={setShowPicModal} index={index} setIndex={setIndex} profiles ={profiles}/>}
            
        </div>
      </div>
      <div clasName='mt-4'>
              <h1 className='text-white fs-5 mt-3 mb-3'>Casting</h1>
              {cast.length>0 ? (
                <Row className='gy-2'>
                  {cast.map((movie)=>(
